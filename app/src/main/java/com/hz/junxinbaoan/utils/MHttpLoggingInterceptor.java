...
public class MHttpLoggingInterceptor implements Interceptor{
    ...
    public MHttpLoggingInterceptor(HttpLoggingInterceptor.Logger logger) {
        this.logger = logger;
    }
                ...
                if (contentLength != 0) {
                    ...
                    try {
                        ...
                        if (!CommonUtils.isEmpty(error)){
                            MyApplication.errorMessage = error;

                        }
                        switch (code){
                            case 9998:
                                MyApplication.errorMessage="用户信息过期!";
                                break;
                            case 9997:
                                MyApplication.errorMessage="账号异地登录!";
                                break;
                            default:
                        ...
                        if (data.equals("用户名或密码错误！")){
                            MyApplication.errorMessage="用户名或密码错误！";
                        }
